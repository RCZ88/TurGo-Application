...
public class CreateCourse extends AppCompatActivity {
    ...
    protected ArrayList<DayTimeArrangement> dtas;
    ...
    int currentPhase;
    Admin admin = (Admin) getIntent().getSerializableExtra("adminObj");
    ...
    private void createCourse(){
        ...
        courseManager.storeData(FirebaseNode.COURSE.getPath(), courseId, course,
                "CourseCreateStatus", "Course created successfully");
